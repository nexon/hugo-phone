...
El subsistema \texttt{uinput} del kernel Linux permite a un proceso en \emph{user space} crear dispositivos de entrada virtuales. El kernel los expone como cualquier teclado físico bajo \texttt{/dev/input/eventXX} y aplicaciones como DOSBox no pueden distinguirlos de hardware real.
...
Con el bridge corriendo, DOSBox mostrando Hugo en la TV y Linphone registrado:
...
\begin{itemize}
  \item DOSBox requiere tener el foco de ventana. Si se lanzó vía SSH con X-forwarding, lo pierde.
