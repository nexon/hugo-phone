...
SIP User ID & 101 \\
Authenticate ID & 101 \\
Authenticate Password & el secreto de 101 en \texttt{pjsip.conf} \\
...
\begin{plaincode}
hugo-pbx*CLI> pjsip show contacts
 Contact:  <Aor/ContactUri............................>  <Hash....> <Status> <RTT(ms)..>
========================================================================================
 Contact:  101/sip:101@192.168.1.11:5060                  abcdef0123 Avail        5.000
\end{plaincode}

La extensión 101 debe aparecer con la IP del HT801 y estado \texttt{Avail}. Si dice \texttt{Unavail} o el contacto no aparece, verificar:

\begin{itemize}
  \item Coincidencia de contraseñas entre HT801 y \texttt{pjsip.conf}.
...
\begin{enumerate}
  \item Confirmar que DOSBox muestra Hugo en la TV.
...
El dialplan tiene un timeout de 3600 segundos (1 hora) en \texttt{Read()}. Si la llamada cae antes, probablemente un \emph{session timer} está activo. Verificar en \texttt{pjsip.conf} que la plantilla \texttt{endpoint-template} tenga \texttt{timers=no} (equivalente PJSIP de \texttt{session-timers=refuse}).
